    ...
    for _data_name in opt.data_lst[0]:
        ...
        with open(filename, 'w+') as file_to_write:
            ...
            for _model_name in opt.model_lst[0]:
                ...
                case_list0 = os.listdir(gt_src)
                case_list = [x for x in case_list0 if 'DS_Store' not in x ]
...
if __name__ == '__main__':
    ...
    parser.add_argument(
        ...
        nargs='+', action='append',default=[['TestEasyDataset/Seen', 'TestHardDataset/Seen', 'TestHardDataset/Unseen', 'TestEasyDataset/Unseen']],
    ...
    parser.add_argument(
        ...
        default='') #Ablation/Benchmark_ours_wo_PDFA
    parser.add_argument(
